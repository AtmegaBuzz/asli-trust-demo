...
import { ArrowLeft, MapPin, Star, Briefcase, Calendar, Shield, Eye, X, Copy, Phone, Mail } from 'lucide-react';
...
export default function WorkerDetailPage({ workerId }: WorkerDetailPageProps) {

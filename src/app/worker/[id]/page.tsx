...
export default function WorkerDetailPage({ params }: WorkerDetailPageProps) {
    ...
    const workerQRRef = useRef<HTMLDivElement>(null);
    ...
    useEffect(() => {
        import('qr-code-styling').then((QRCodeStylingLib) => {
            ...
            const qrCode = new QRCodeStyling({
                ...
                height: 200,
                type: "svg",
                data: `${window.location.origin}/worker/trust-score/${resolvedParams.id}`,
                image: "/alan-scott.png",
                dotsOptions: {
                    color: "#1e40af", // Blue dots
                    type: "rounded"
            ...
            if (workerQRRef.current) {
                workerQRRef.current.innerHTML = ''
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <div className="border-t pt-4 mt-7">
                                <h3 className="text-sm font-medium text-gray-700 mb-3">Worker QR</h3>
                                <div className="w-full flex justify-start">
                                    <div ref={workerQRRef} className="flex justify-center"></div>
                                </div>
                            </div>
                        </div>
                    </div>
